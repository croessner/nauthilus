...
func DTOToAuthRequest(dto authdto.Request) *authv1.AuthRequest {
...
func DTOToLookupIdentityRequest(dto authdto.Request) *authv1.LookupIdentityRequest {
...
func DTOToListAccountsRequest(dto authdto.Request) *authv1.ListAccountsRequest {
