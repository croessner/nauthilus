...
func TestCommonProtoContract(t *testing.T) {
	...
	fileDescriptor := commonv1.File_api_common_v1_common_proto
...
func assertOperationResultValues(t *testing.T) {
	...
	cases := []struct {
		name  string
		value commonv1.OperationResult
		want  int32
	}{
		{name: "unspecified", value: commonv1.OperationResult_OPERATION_RESULT_UNSPECIFIED, want: 0},
		{name: "ok", value: commonv1.OperationResult_OPERATION_RESULT_OK, want: 1},
		{name: "fail", value: commonv1.OperationResult_OPERATION_RESULT_FAIL, want: 2},
		{name: "tempfail", value: commonv1.OperationResult_OPERATION_RESULT_TEMPFAIL, want: 3},
		{name: "denied", value: commonv1.OperationResult_OPERATION_RESULT_DENIED, want: 4},
		{name: "not_found", value: commonv1.OperationResult_OPERATION_RESULT_NOT_FOUND, want: 5},
		{name: "conflict", value: commonv1.OperationResult_OPERATION_RESULT_CONFLICT, want: 6},
	}
