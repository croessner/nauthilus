...
// Encrypt encrypts data using ChaCha20-Poly1305 and a secret string.
...
// Decrypt decrypts data using ChaCha20-Poly1305 and a secret string.
...
func EncryptString(plaintext, secret string) ([]byte, error) {
