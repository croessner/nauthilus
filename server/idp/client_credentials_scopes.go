...
// ValidateClientCredentialsScopes rejects OIDC identity scopes for service tokens.
func ValidateClientCredentialsScopes(scopes []string) error {
	if slices.Contains(scopes, definitions.ScopeOpenID) {
		return ErrClientCredentialsOpenIDScope
	}
