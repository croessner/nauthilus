...
-- IdP Policy Subject Example
--
-- This subject source demonstrates how to use the IdP-specific fields available in the
...
--
-- Return values:
--   nauthilus_builtin.SUBJECT_ACCEPT  - Allow the request
--   nauthilus_builtin.SUBJECT_REJECT  - Deny the request
--   nauthilus_builtin.SUBJECT_RESULT_OK   - No error during subject execution
--   nauthilus_builtin.SUBJECT_RESULT_FAIL - Error during subject execution
--
