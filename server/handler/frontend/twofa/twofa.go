...
func (h *Handler) Register(router gin.IRouter) {
	...
	twoFactorGroup := common.RouterGroup(h.Deps.Cfg, h.Deps.Logger, h.Deps.Redis, h.Deps.AccountCache, h.Deps.Cfg.GetServer().Frontend.GetLogin2FAPage(), group, h.Store, h.Deps.Svc.LoginGET2FAHandler(), h.Deps.Svc.LoginPOST2FAHandler())
	...
	common.RouterGroup(h.Deps.Cfg, h.Deps.Logger, h.Deps.Redis, h.Deps.AccountCache, h.Deps.Cfg.GetServer().Frontend.GetTotpPage(), group, h.Store, h.Deps.Svc.RegisterTotpGETHandler(), h.Deps.Svc.RegisterTotpPOSTHandler())
}
