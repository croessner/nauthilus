...
func AuthRequestToDTO(request *authv1.AuthRequest) authdto.Request {
	if request == nil {
...
func ListAccountsRequestToDTO(request *authv1.ListAccountsRequest) authdto.Request {
	if request == nil {
		return authdto.Request{}
	}
...
func LookupIdentityRequestToDTO(request *authv1.LookupIdentityRequest) authdto.Request {
	if request == nil {
		return authdto.Request{}
	}
...
// structuredAuthRequestToDTO maps fields shared by auth and identity lookup requests.
