...
func builtinAuthnCommonFactSchemaInputs() []FactSchemaInput {
	return []FactSchemaInput{
		...
		builtinAuthnFactSchemaInput(policy.AuthnFactRequestClientIP, decision.FactCategoryEnvironment, decision.ValueKindString, decision.FactSourceNauthilus),
		builtinAuthnFactSchemaInput(policy.AuthnFactRequestClientIPPresent, decision.FactCategoryEnvironment, decision.ValueKindBoolean, decision.FactSourceNauthilus),
		builtinAuthnFactSchemaInput(policy.AuthnFactRequestClientIPTrusted, decision.FactCategoryEnvironment, decision.ValueKindBoolean, decision.FactSourceNauthilus),
		builtinAuthnFactSchemaInput(policy.AuthnFactRequestCallerIP, decision.FactCategoryEnvironment, decision.ValueKindString, decision.FactSourceNauthilus),
		builtinAuthnFactSchemaInput(policy.AuthnFactRequestCallerIPPresent, decision.FactCategoryEnvironment, decision.ValueKindBoolean, decision.FactSourceNauthilus),
		builtinAuthnFactSchemaInput(policy.AuthnFactRequestLocalIP, decision.FactCategoryEnvironment, decision.ValueKindString, decision.FactSourceNauthilus),
		builtinAuthnFactSchemaInput(policy.AuthnFactRequestLocalIPPresent, decision.FactCategoryEnvironment, decision.ValueKindBoolean, decision.FactSourceNauthilus),
