...
func parserBackedContractDocuments() []openAPIContractDocument {
	return []openAPIContractDocument{
		...
		},
		{
			...
			optionalAnonymousOperations: openAPIOperationSet(operationExpectation{method: methodPost, path: "/oidc/token"}),
			publicOperations: openAPIOperationSet(
				...
				operationExpectation{method: methodPost, path: pathOIDCRegister},
