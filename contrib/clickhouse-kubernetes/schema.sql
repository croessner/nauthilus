...
CREATE TABLE IF NOT EXISTS nauthilus.failed_logins (
  ...
  INDEX idx_username   username   TYPE tokenbf_v1(1024) GRANULARITY 64,
  INDEX idx_account    account    TYPE tokenbf_v1(1024) GRANULARITY 64,
  INDEX idx_client_ip  client_ip  TYPE tokenbf_v1(1024) GRANULARITY 64
) ENGINE = MergeTree
ORDER BY (ts)
