...
func (h *Handler) Register(router gin.IRouter) {
	...
	twoFactorGroup := common.RouterGroup(h.Deps.Cfg, h.Deps.Logger, h.Deps.Redis, h.Deps.AccountCache, viper.GetString("login_2fa_page"), group, h.Store, h.Deps.Svc.LoginGET2FAHandler(), h.Deps.Svc.LoginPOST2FAHandler())
	...
	common.RouterGroup(h.Deps.Cfg, h.Deps.Logger, h.Deps.Redis, h.Deps.AccountCache, viper.GetString("totp_page"), group, h.Store, h.Deps.Svc.RegisterTotpGETHandler(), h.Deps.Svc.RegisterTotpPOSTHandler())
}
