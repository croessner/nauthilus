...
func newReputationTelemetry(cfg *configuration, host pluginapi.Metrics) (*reputationTelemetry, error) {
	...
	results := telemetry.Dimension{Name: metricResult, Values: []string{storageApplied, storageDuplicate, learningRejected, learningUnavailable, learningPartial, learningQueued, storageQuotaExceeded}}
