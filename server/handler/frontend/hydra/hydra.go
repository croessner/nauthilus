...
func (h *Handler) Register(router gin.IRouter) {
	...
	// Login page
	common.RouterGroup(h.Deps.Cfg, h.Deps.Logger, h.Deps.Redis, viper.GetString("login_page"), router, h.Store, h.Deps.Svc.LoginGETHandler(), h.Deps.Svc.LoginPOSTHandler())

	// Device/U2F/FIDO2 login page
	common.RouterGroup(h.Deps.Cfg, h.Deps.Logger, h.Deps.Redis, viper.GetString("device_page"), router, h.Store, h.Deps.Svc.DeviceGETHandler(), h.Deps.Svc.DevicePOSTHandler())

	// Consent page
	common.RouterGroup(h.Deps.Cfg, h.Deps.Logger, h.Deps.Redis, viper.GetString("consent_page"), router, h.Store, h.Deps.Svc.ConsentGETHandler(), h.Deps.Svc.ConsentPOSTHandler())

	// Logout page
	common.RouterGroup(h.Deps.Cfg, h.Deps.Logger, h.Deps.Redis, viper.GetString("logout_page"), router, h.Store, h.Deps.Svc.LogoutGETHandler(), h.Deps.Svc.LogoutPOSTHandler())
}
